...
st.markdown("""
 ...
 Par exemple, si on dispose d'un échantillon multivarié ou multidimensionnel et qu'on cherche à déterminer si ses caractéristiques peuvent être extrapolées à la population, la variable la plus importante pourrait être le type de dossier (dossier normal ou dossier suspect contenant des anomalies). 
